              ...
              <div>
                {loading ? (
                  ...
                  Professors.map((Professor, index) => (
                    <div className="flex flex-col rounded-xl p-3 bg-white border border-gray-700 border-opacity-70 mb-4">
                      <span className="flex border-b border-gray-800 border-opacity-60 w-full mb-2 items-center pb-2">
                        <p className="text-white-800 font-semibold text-lg mr-3">
