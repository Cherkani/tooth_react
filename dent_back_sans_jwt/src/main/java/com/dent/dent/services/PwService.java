...
public class PwService implements IDao<PW> {
    ...
    public String uploadDocument(PW pw, MultipartFile file) {
        try {
            ...
            Files.copy(file.getInputStream(), Paths.get("C:\\Users\\cherk\\Desktop\\projetdent", fileName), StandardCopyOption.REPLACE_EXISTING);
            return fileName;
        } catch (IOException e) {
    ...
    public ResponseEntity<Resource> downloadDocument(long id) {
        ...
        try {
            ...
            Resource resource = new UrlResource("file:C:\\Users\\cherk\\Desktop\\projetdent\\" + filename);
